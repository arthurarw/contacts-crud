    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="grid grid-cols-2 gap-2">
        ...
        <div class="mb-4">
          ...
          <input v-mask="['(##) ####-####', '(##) #####-####']" v-model="phone" v-bind="phoneAttrs" type="text" id="phone" class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" placeholder="Your phone" />
